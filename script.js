...
function start() {  // функция спрашивает месячный бюджет и дату
    money = +prompt ("Ваш бюджет на месяц?", "");
    time = prompt ("Введите дату в формате YYYY-MM-DD", "");

    while (isNaN(money) || money == "" || money == null) { //проверка что бюджет есть число, не пустая строка и не отменен
        money = +prompt ("Введите повторно Ваш бюджет на месяц?", ""); 
    }
